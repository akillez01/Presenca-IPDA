...
export default function CartaRecomendacaoPage() {
  ...
  function handlePrint() {
    // Criar uma nova janela/aba para visualização no navegador
    const printWindow = window.open('', '_blank', 'width=1200,height=800');
    
    if (printWindow) {
      // Obter o HTML completo da página atual
      ...
      printWindow.document.write(`
        ...
        <html>
        <head>
          <title>Carta de Recomendação IPDA</title>
          <meta charset="utf-8">
          <style>
            @media print {
              @page {
              ...
              /* Remove URL e outras informações do cabeçalho/rodapé */
              @page :first {
                margin-top: 0.5in;
              }
            }
