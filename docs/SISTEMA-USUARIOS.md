...
- **Credenciais:**
  ...
  - Email: `admin@ipda.org.br` / Senha: definida em `credentials.local.json`
  - Email: `marciodesk@ipda.app.br` / Senha: definida em `credentials.local.json`
...
- **Credenciais:**
  ...
  - Email: `presente@ipda.app.br` / Senha: definida em `credentials.local.json`
  - Email: `cadastro@ipda.app.br` / Senha: definida em `credentials.local.json`
  - Email: `registro1@ipda.app.br` / Senha: definida em `credentials.local.json`
  - Email: `registro2@ipda.app.br` / Senha: definida em `credentials.local.json`
  - Email: `registro3@ipda.app.br` / Senha: definida em `credentials.local.json`
  - Email: `registro4@ipda.app.br` / Senha: definida em `credentials.local.json`
  - Email: `secretaria@ipda.org.br` / Senha: definida em `credentials.local.json`
  - Email: `auxiliar@ipda.org.br` / Senha: definida em `credentials.local.json`
...
Para adicionar novos usuários, edite o arquivo local `credentials.local.json` (não versionado):

```typescript
{
  "users": {
    "novo_usuario": {
      "email": "novo-usuario@ipda.org.br",
      "password": "DEFINIR_SENHA_SEGURA_AQUI",
...
2. Vá para `/login`
3. Teste com as credenciais locais definidas em `credentials.local.json`
...
- `credentials.local.json` (local): Credenciais operacionais fora do Git remoto
